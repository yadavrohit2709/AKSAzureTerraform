...
# checkov:skip=CKV_AZURE_169: Using manual node pool for legacy application compatibility
...
# checkov:skip=CKV_AZURE_8: Kubernetes dashboard disabled by default in newer provider versions
# checkov:skip=CKV_AZURE_246: HTTP routing disabled
